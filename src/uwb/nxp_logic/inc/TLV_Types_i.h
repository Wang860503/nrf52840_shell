...
typedef enum { notCreated, notStarted, Started } UwbHandlerState;
 ...
 */
#define SPEC_VERSION_MAJOR {0x01, 0x00}  // Spec major 00.01
#define SPEC_VERSION_MINOR {0x00, 0x00}  // Spec minor 01.00
