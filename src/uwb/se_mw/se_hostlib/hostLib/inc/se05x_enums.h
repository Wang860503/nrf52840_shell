...
typedef enum {
  ...
  /** Mask for authentication object creation, can only be combined with
     INS_WRITE */
...
/** Different signature algorithms for ECDAA (This is deprecated. This will be
...
#define kSE05x_ECCurve_RESERVED_ID_ECC_MONT_DH_25519 \
  kSE05x_ECCurve_ECC_MONT_DH_25519
#if SSS_HAVE_SE05X_VER_GTE_06_00
#define kSE05x_ECCurve_RESERVED_ID_ECC_MONT_DH_448 \
...
/**
 * the maximum APDU payload length will be smaller, depending on which protocol
 * applies, etc.
 */
...
/** [Optional: if the authentication key is the same as the key to be replaced,
 * this TAG should not be present]. */
