...
/* The following marker is used by firmware integration script, do not edit or
   delete these comments unintentionally, applicable for all the markers in this
   file */
/* Selection For SR150 FW Starts Here */
#if UWBIOT_SR1XX_FW_ROW_PROD
#define H1_IOT_SR150_MAINLINE_PROD_FW_46_41_06_0052bbfed983a1f1_bin \
  heliosEncryptedMainlineFwImage
#define H1_IOT_SR150_MAINLINE_PROD_FW_46_41_06_0052bbfed983a1f1_bin_len \
  heliosEncryptedMainlineFwImageLen
#elif UWBIOT_SR1XX_FW_RHODES3_PROD
#define SR140_SR150_FW_BX_RHODES3_PROD_20220316_a39c6fcb_B1v32_00_FB_bin \
  heliosEncryptedMainlineFwImage
#define SR140_SR150_FW_BX_RHODES3_PROD_20220316_a39c6fcb_B1v32_00_FB_bin_len \
  heliosEncryptedMainlineFwImageLen
#elif UWBIOT_SR1XX_FW_ROW_DEV
#define H1_IOT_SR150_MAINLINE_DEV_FW_46_41_06_0052bbfed983a1f1_bin \
  heliosEncryptedMainlineFwImage
#define H1_IOT_SR150_MAINLINE_DEV_FW_46_41_06_0052bbfed983a1f1_bin_len \
  heliosEncryptedMainlineFwImageLen
#elif UWBIOT_SR1XX_FW_RHODES3_DEV
#define SR140_SR150_FW_BX_RHODES3_20220316_a39c6fcb_B1v32_00_FB_bin \
  heliosEncryptedMainlineFwImage
#define SR140_SR150_FW_BX_RHODES3_20220316_a39c6fcb_B1v32_00_FB_bin_len \
  heliosEncryptedMainlineFwImageLen
#else
...
#define H1_MOBILE_ROW_MAINLINE_RHODES3_PROD_FW_44_00_01_572492a66aac2909_bin \
  heliosEncryptedMainlineFwImage
#define H1_MOBILE_ROW_MAINLINE_RHODES3_PROD_FW_44_00_01_572492a66aac2909_bin_len \
  heliosEncryptedMainlineFwImageLen
#elif UWBIOT_SR1XX_FW_RHODES3_DEV
#define H1_MOBILE_ROW_MAINLINE_RHODES3_DEV_FW_44_00_01_572492a66aac2909_bin \
  heliosEncryptedMainlineFwImage
#define H1_MOBILE_ROW_MAINLINE_RHODES3_DEV_FW_44_00_01_572492a66aac2909_bin_len \
  heliosEncryptedMainlineFwImageLen
#elif UWBIOT_SR1XX_FW_ROW_PROD
#define H1_MOBILE_ROW_MAINLINE_PROD_FW_EE_20_A0_a8b28afc11bdaf6c_bin \
  heliosEncryptedMainlineFwImage
#define H1_MOBILE_ROW_MAINLINE_PROD_FW_EE_20_A0_a8b28afc11bdaf6c_bin_len \
  heliosEncryptedMainlineFwImageLen
#elif UWBIOT_SR1XX_FW_ROW_DEV
#define H1_MOBILE_ROW_MAINLINE_DEV_FW_EE_20_A0_a8b28afc11bdaf6c_bin \
  heliosEncryptedMainlineFwImage
#define H1_MOBILE_ROW_MAINLINE_DEV_FW_EE_20_A0_a8b28afc11bdaf6c_bin_len \
  heliosEncryptedMainlineFwImageLen
#else
#error "Select anyone of the FW"
#endif
...
#elif UWBIOT_SR1XX_FW_ROW_PROD
#define H1_IOT_SR150_MAINLINE_PROD_FW_EE_40_02_746b01d41a254ace_bin \
  heliosEncryptedMainlineFwImage
#define H1_IOT_SR150_MAINLINE_PROD_FW_EE_40_02_746b01d41a254ace_bin_len \
  heliosEncryptedMainlineFwImageLen
#elif UWBIOT_SR1XX_FW_ROW_DEV
#define H1_IOT_SR150_MAINLINE_DEV_FW_EE_40_02_746b01d41a254ace_bin \
  heliosEncryptedMainlineFwImage
#define H1_IOT_SR150_MAINLINE_DEV_FW_EE_40_02_746b01d41a254ace_bin_len \
  heliosEncryptedMainlineFwImageLen
#else
#error "Select anyone of the FW"
#endif
 ...
 * 2) in the generated header file, replace ``unsigned char`` to ``const
 * uint8_t``
 */
