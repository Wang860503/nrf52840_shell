...
/* UWA_DM callback */
typedef void(tUWA_DM_RSP_CBACK)(uint8_t gid, uint8_t oid, uint16_t len,
                                uint8_t* eventData);
typedef void(tUWA_DM_NTF_CBACK)(uint8_t gid, uint8_t oid, uint16_t len,
                                uint8_t* eventData);
...
typedef void(tUWA_RAW_CMD_CBACK)(uint8_t gid, uint8_t event, uint16_t param_len,
                                 uint8_t* p_param);
