...
/* Max input buffer size for firmware download
 * PHHBCI_MAX_LEN_DATA_MOSI - 2048 bytes
 * PHHBCI_LEN_LRC - 1 byte
 * PHHBCI_LEN_HDR - 4 byte
 */
#define PHHBCI_MAX_LEN_PAYLOAD_MOSI (PHHBCI_MAX_LEN_DATA_MOSI + PHHBCI_LEN_LRC + PHHBCI_LEN_HDR)

#define PHHBCI_MAX_LEN_DATA_MISO (256U)
/* Max out buffer size for firmware download response
 * PHHBCI_MAX_LEN_DATA_MISO - 255 bytes
 * PHHBCI_LEN_LRC - 1 byte
 */
...
EXTERNC void UWB_HeliosCE(bool set);
