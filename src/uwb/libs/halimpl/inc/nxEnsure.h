 ...
 * During retail builds, such loggings would be of any use and remove and reduce
 * code size.
 *
 */
...
#define NX_ENSURE_MESSAGE(strCONDITION)                               \
  LOG_W("nxEnsure:'" strCONDITION "' failed. At Line:%d Function:%s", \
 ...
 *
 *      value = Operation2();
 *      ENSURE_OR_QUIT_WITH_STATUS_ON_ERROR(0 == value, status,
