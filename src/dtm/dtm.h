 ...
 * Note: This function does NOT initialize Radio or connect interrupts.
 * Call dtm_start() to actually start DTM.
 *
...
/** @brief Start the DTM module.
 *
 * This function initializes Radio and connects interrupts dynamically.
 * Must be called after dtm_init() to actually start DTM functionality.
 *
 * @return 0 in case of success or negative value in case of error.
 */
int dtm_start(void);

/** @brief Stop the DTM module.
 *
 * This function deinitializes Radio, disconnects interrupts, and stops any running tests.
 * After calling this function, DTM can be restarted by calling dtm_start() again.
 *
 * @return 0 in case of success or negative value in case of error.
 */
int dtm_stop(void);
